...
from laya.common import DecisionModel, render_options, to_internal  # noqa: E402
...
internal = to_internal(got_questions["intent"])
...
# list criteria stay a list, in rank order, and to_internal accepts them
list_agent = Recorder()
...
check(
    ...
    list(to_internal(list_agent.calls[0][1]["intent"])["crit"]),
    ["beta", "alpha"],
)
...
scored = to_internal(pipe_agent.calls[0][1]["intent"])
